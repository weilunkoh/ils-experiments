...
srun --gres=gpu:1 python -m scripts.extract_features --embed_model_name clip --data_folder_name val
srun --gres=gpu:1 python -m scripts.extract_features --embed_model_name clip --data_folder_name train
