...
srun --gres=gpu:1 python -m scripts.compute_centroids  --embed_model_name clip --data_folder_name train --clustering_method kmeans --num_centroids 30 --centroids_initialisation k-means++ --max_iter 300 --random_state 42
